                                ...
                                <>
                                    ...
                                    <div className="row video-box col-12 my-lg-4 my-2">
                                        <div className="col-lg-12">
                                            ...
                                            <VideoPlayer videoSrc="https://profile.kfp-dental.com/account/training.mp4" />
                                        </div>
                                        <div className="col-lg-8">

                                            <div className="video-body mt-lg-3">
                                                <h5 className="card-title text-light fs-3 fw-bold">Layering_Pattern</h5>
                                                <p className="card-text text-light opacity-75 mt-lg-3 mt-2">
                                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nostrum, distinctio incidunt quod vitae praesentium dignissimos officia beatae dolor totam repellendus earum quidem, id corporis non nihil, doloribus nulla consequuntur odio.
                                                </p>
                                            </div>
