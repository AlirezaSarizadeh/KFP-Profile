        ...
        try {
            ...
            if (result.status === 203) {
                ...
                swal({
                    ...
                    navigate('/login-avita'); // Redirect to dashboard
                });
            }
            else {
    ...
    return (
        <>
            <section className="auth-container" style={{ backgroundImage: `url(${authBg})` }}>
                <img src={avitaLoginPic_mobile} className="d-lg-none dentist-img-mobile" alt="" style={{ borderRadius: '0 0 200px 200px' }} />
                <div className="row auth-div justify-content-center">
                    <div className="col-lg-5 d-none d-lg-flex">
                        <img src={avitaLoginPic_desktop} className="img-fluid w-75 m-auto auth-img" alt="" />
                    </div>
